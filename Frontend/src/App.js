...
const ManageFoodCard = lazy(() =>
  import("./component/managePost/managePost.js")
);
const PickupHistoryLandingPage = lazy(() =>
  import("./component/pickupHistory/pickuphistoryLandingPage.js")
);
const ProfilePage = lazy(() =>
  import("./component/userProfilePage/userProfile.js")
);
const MyPickup = lazy(() => import("./component/myPickup/myPickup.js"));
const DashBoard = lazy(() =>
  import("./component/dashboardPage/dashboardLandingPage.js")
);
const DontaionRegistrationForm = lazy(() =>
  import("./component/dontationPostRegistration/dontaionPostRegistration.js")
);
const ContactPage = lazy(() =>
  import("./component/contactPage/contactPage.js")
);
const App = () => {
  return (
    <BrowserRouter>
